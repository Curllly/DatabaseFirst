...
using ReceiptsList.Models;

namespace ReceiptsList.Database;

public partial class DatabaseFirstReceiptsAgeevContext : DbContext
{
    public DatabaseFirstReceiptsAgeevContext()
    {
    }

    public DatabaseFirstReceiptsAgeevContext(DbContextOptions<DatabaseFirstReceiptsAgeevContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server = PAWOK; Database = DatabaseFirstReceipts_Ageev; Trusted_Connection = true; TrustServerCertificate = true");
